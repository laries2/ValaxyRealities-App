                ...
                <div class="col-lg-12">
                    ...
                    if (isset($_POST['publish'])) {
                        ...
                        $gump->validation_rules(array(
                            'title'    => 'required|max_len,120|min_len,10',
                            'tags'   => 'required|max_len,100|min_len,3',
                            'content' => 'required|max_len,20000|min_len,15',
                        ));
                        ...
                        if($validated_data === false) {
                            ...
                            $validExt = array ("vide/mp4",  "video/avi",  "video/3gp", "video/mkv");

                            if (empty($image)) {
                                echo "<script>alert('Attach a video);</script>";
                            }
                            else if ($_FILES['image']['size'] <= 0 || $_FILES['image']['size'] > 10240000000000 )
                            {
                                echo "<script>alert('video size is not proper');</script>";
                            }
